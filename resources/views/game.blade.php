    ...
    <div class="container contenedor-juego">
        ...
        @guest
                <div class="caratula-pago en-biblioteca">
                    <img src="{{url('storage/images/'.$juego[0]->cover)}}" class="img-fluid borde-luminoso caratula" alt="...">
                ...
                <div class="row">
                    ...
                    @forelse ($comentarios as $comentario)  
                            <div class="comment mt-4 text-justify float-left">
                                ...
                                <img src="{{url('storage/images/'.$comentario->avatar)}}" alt="" class="rounded-circle" width="40" height="40">
                                @else
                                <img src="{{url('storage/images/'.'default.svg')}}" alt="" class="rounded-circle" width="40" height="40">
                                @endif
