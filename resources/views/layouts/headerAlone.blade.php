    ...
    <body>
        <nav class="fixed-top position-fixed navbar navbar-expand-lg navbar-light navegador">
            <div class="container-fluid separador">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 listaNav listaJP"></ul> 
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div id="menuUsuario" class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                ...
                                @if (Auth::user()->hasRole(['user']))                            
                                    <a class="dropdown-item" href="/plans">Gestionar planes</a>
                                @endif
                                @if (Auth::user()->hasRole(['creator']))                            
                                    <a class="dropdown-item" href="#">Añadir juego/Proyecto</a>
                                    <a class="dropdown-item" href="/plans">Gestionar planes</a>
                                @endif
