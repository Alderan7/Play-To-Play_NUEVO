...
<div class="margen container">
        ...
        <div class="perfil">
            ...
            @if (is_null($usuario->avatar))
                <img class="avatar" src="{{$url_image}}default.svg">
            @else
                <img class="avatar" src="{{$url_image}}{{ $usuario->avatar }}">
            @endif
                <div class="datos">
                    <h1>{{$usuario->name}}</h1>                    
        ...
        @foreach ($juegos as $juego)  
            <div class="interno">
                ...
                @if (remote_file_exists($juego->archives)) 
                    <a href="{{$juego->archives}}" class="btn-card"><img class="rounded mx-auto d-block imagen-juego" src="{{$url_image}}{{$juego->cover}}"  alt="Card image cap"><div class="nombre-juego"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 50 50" width="50pt" height="50pt"><defs><clipPath id="_clipPath_sZv9G6xcZeQw4DST1umJy0k0e2VATlNl"><rect width="50" height="50"/></clipPath></defs><g clip-path="url(#_clipPath_sZv9G6xcZeQw4DST1umJy0k0e2VATlNl)"><image xlink:href="data:image/png;base64," x="4.809" y="0" width="40.381" height="50" style=""/></g></svg></div></a>
                @else
                    <a href="#" class="btn-card"><img class="rounded mx-auto d-block imagen-juego" src="{{$url_image}}{{$juego->cover}}"  alt="Card image cap"><div class="nombre-juego-error"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="isolation:isolate" viewBox="0 0 50 50" width="50pt" height="50pt"><defs><clipPath id="_clipPath_sZv9G6xcZeQw4DST1umJy0k0e2VATlNl"><rect width="50" height="50"/></clipPath></defs><g clip-path="url(#_clipPath_sZv9G6xcZeQw4DST1umJy0k0e2VATlNl)"><image xlink:href="data:image/png;base64," x="4.809" y="0" width="40.381" height="50" style=""/></g></svg></div></a> 
                @endif
        ...
        @forelse ($proyectos as $proyecto)  
            <div class="interno">
            <a href="#" class="btn-card"><img class="rounded mx-auto d-block imagen-juego" src="{{$url_image}}{{$proyecto->cover}}"  alt="Card image cap"><div class="nombre-juego">{{$proyecto->name}}</div></a> 
            </div>
        @endforeach
